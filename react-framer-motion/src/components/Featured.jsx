  ...
  return (
    <div className=' w-full py-20 bg-white text-black'>
        ...
        <div className='px-20'>
            ...
            <Card imgSrc={"//ochi.design/wp-content/uploads/2023/10/Fyde_Illustration_Crypto_2-663x551.png"}/>
            ...
            <Card imgSrc={"//ochi.design/wp-content/uploads/2022/09/Vise_front2-663x551.jpg"}/>
            <div className='button mt-4'>
                <button className=' px-3 py-[2px] border-black rounded-3xl border mr-2'>
                    AGENCY
                </button>
            ...
            <div>
            <div className=' px-5 py-5 flex align-middle gap-3'>
                     <div className=' h-3 w-3 rounded-full bg-black mt-1.5'></div> tra 
                    </div>
            <Card imgSrc={"//ochi.design/wp-content/uploads/2023/08/Frame-3875-663x551.jpg"}/>
            <div className='button mt-4'>
                <button className=' px-3 py-[2px] border-black rounded-3xl border mr-2'>
                    BRAND IDENTITY
                </button>
            ...
            <Card imgSrc={"//ochi.design/wp-content/uploads/2022/12/PB-Front-4-663x551.png"}/>
            <div className='button mt-4'>
                <button className=' px-3 py-[2px] border-black rounded-3xl border mr-2'>
                    BRAND TEMPLATE
                </button>
