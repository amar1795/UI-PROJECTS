...
const Footer = () => {
  return (
    <div className=' text-black w-full flex flex-wrap justify-between font-["Test Founders Grotesk X-cond Sm Semi Bold"] h-screen bg-white p-20'>
        <div className=' w-1/2 h-full relative'>
            <div className='heading'>
                
                <h1 className=' text-[8vw] font-semibold uppercase leading-none -mb-5 tracking-tighter'>Eye-</h1>
                <h1 className=' text-[8vw] font-semibold uppercase leading-none -mb-10 tracking-tighter'>Opening</h1>
            
            </div>
            <div className='ochi absolute bottom-10'>
        ...
        <div className=' w-1/2 h-full' >
            ...
            <h1 className=' text-[6vw]  font-bold uppercase'>
                presentations
            </h1>

            <div className=' socials font-["Neue Montreal"] mt-20 underline '>
                <a href="#" className='block text-xl font-medium'>Facebook</a>
                <a href="#" className='block text-xl font-medium'>Instagram</a>
                <a href="#" className='block text-xl font-medium'>Twitter</a>
